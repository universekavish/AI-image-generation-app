...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(form.prompt && form.photo){
      ...
      alert('Please enter a prompt and generate an image to share first.')
    }
  }
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="text-white bg-green-700 font-medium rounded-md test-sm w-full sm:w-auto px-5 py-2.5 text-center"
          >
